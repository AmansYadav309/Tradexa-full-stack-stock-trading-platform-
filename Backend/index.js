...
//to add the initial dumey data in DB (Holdings data )
...
//to add the initial dumey data in DB (Position data )
app.get('/addPosition', async (req, res) => {
    ...
    //  newPosition.save()
    // })
    res.send("data allready feeded")
})

//to featch(get) the data from database (Holdings data)
app.get('/allHoldings', async (req, res) => {
    let allHoldingsData = await HoldingsModel.find({});
    res.json(allHoldingsData);
})

//to featch(get) the data from database (POsition data)
